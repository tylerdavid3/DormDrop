...
function renderLoggedOutState() {
  ...
  if (pg)
    pg.innerHTML =
      ...
      '<p class="rm-cta-desc">Create a free DormDrop account to take the lifestyle quiz and see compatible Merrimack students with built-in messaging. We match on sleep schedule, study habits, cleanliness, and more — not just proximity.</p>' +
      '<ul class="rm-cta-bullets">' +
      '<li><span class="rm-cta-check">&#10003;</span> Match with verified Merrimack students only</li>' +
